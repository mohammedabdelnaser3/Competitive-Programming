...
int query(int s, int e, int node, int l, int r){
    ...
    int md = (s + e) >> 1;
    dbg(s, e, md);
    return query(s, md, 2 * node, l, r) + query(md + 1, e, 2 * node + 1, l, r);
}
